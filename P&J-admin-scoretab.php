  ...
  <body style="background: rgb(25,20,36);">
    ...
    <div class="container" style="margin:auto;">
        <div class="row" style="margin-top: 16px;">
            <div class="col-xl-3 col-xxl-2 offset-xxl-0"><label class="form-label" style="color: rgb(255,255,255);">Events</label><br>
            ...
            <div class="col"><label class="form-label" style="color: rgb(255,255,255);">Group</label><br>
                <select style="border-radius: 10px;width: 180.031px;height: 40px;margin-left: 19px;background: var(--bs-light);color: var(--bs-body-color); text-align: center;">IT Week
                    <option>ITDS</option>
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-lg-6 col-xl-6 col-xxl-4 offset-lg-0 offset-xxl-2"><label class="form-label" style="color: rgb(255,255,255);">Criteria</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col"><input type="number" style="text-align: center;color: rgb(255,255,255);background: rgba(0,0,0,0.22);" placeholder="10"></div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="col offset-xl-2 offset-xxl-1" style="text-align: center;">
                        <div class="btn-toolbar" style="text-align: center;">
                            <div class="btn-group" role="group" style="text-align: center;margin-top: 10px;">
                                <button class="buttonsubmit" type="button" style="text-align: center;margin-left: 60px;width: 76px;height: 38px;border-radius: 15px;color:white;">Save</button>
