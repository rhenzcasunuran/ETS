...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "disqualify") {
        // TODO: Perform the disqualify action for the team with $teamId
        // Example: Update the database record to mark the team as disqualified
        // Prepare and execute the SQL query
        $stmt = $conn->prepare("UPDATE ongoing_teams SET current_team_status = 'disqualified' WHERE id = ?");
        ...
        $response = array("status" => "success", "message" => "Team disqualify successfully");
