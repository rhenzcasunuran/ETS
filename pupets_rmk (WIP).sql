...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2023 at 05:59 AM
...
CREATE TABLE `competitions_table` (
  ...
  `competition_name` int(11) NOT NULL,
...
--
-- Table structure for table `competition_participantsgroup_overall_score`
--

CREATE TABLE `competition_participantsgroup_overall_score` (
  `competition_participantgroup_overall_score_id` int(11) NOT NULL,
  `competition_id` int(11) NOT NULL,
...
--
-- Table structure for table `competition_participantsgroup_score`
--

CREATE TABLE `competition_participantsgroup_score` (
  `participantgroup_score_id` int(11) NOT NULL,
  `participantgroup_id` int(11) NOT NULL,
  `criterion_id` int(11) NOT NULL,
  `competition_id` int(11) NOT NULL,
  `participantgroup_score` decimal(5,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `competition_participants_overall_score`
--

CREATE TABLE `competition_participants_overall_score` (
  `participant_overall_score_id` int(11) NOT NULL,
  `competition_id` int(11) NOT NULL,
...
--
-- Table structure for table `competition_participants_score`
--

CREATE TABLE `competition_participants_score` (
  `participant_score_id` int(11) NOT NULL,
  `participant_id` int(11) NOT NULL,
  `criterion_id` int(11) NOT NULL,
  `competition_id` int(11) NOT NULL,
  `participant_score` decimal(3,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `competition_participant_type`
--

CREATE TABLE `competition_participant_type` (
  `participant_type_id` int(11) NOT NULL,
  `participant_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `competition_participant_type`
--

INSERT INTO `competition_participant_type` (`participant_type_id`, `participant_type`) VALUES
(1, 'individual'),
(2, 'group');
...
INSERT INTO `eventhistorytb` (`event_id`, `category_name_id`, `event_description`, `event_code`, `event_date`, `event_time`, `judge_id`, `suggested_status`) VALUES
(27, 18, 'HAHAHAHAHAHAasdasdasdasd', 'RKDwN2ItD2xs', '2023-06-30', '22:48:00', 0, 0);
...
(1, '2023-06-21', '09:19:21', 1, 'Added in Events');
...
(27, 18, 'HAHAHAHAHAHAasdasdasdasd', 'RKDwN2ItD2xs', '2023-06-30', '22:48:00', 0),
(28, 14, 'asdasdasdasd', '4gSZ7ZqcoDPL', '2023-06-22', '02:24:00', 0);
...
CREATE TABLE `post` (
  ...
  `post_draft` tinyint(1) DEFAULT 0,
...
ALTER TABLE `competitions_table`
  ...
  ADD KEY `participant_type` (`participant_type`),
  ADD KEY `event_name` (`event_name`),
  ADD KEY `event_type` (`event_type`);

--
-- Indexes for table `competition_participantsgroup_overall_score`
--
ALTER TABLE `competition_participantsgroup_overall_score`
  ADD PRIMARY KEY (`competition_participantgroup_overall_score_id`),
  ADD KEY `competition_id` (`competition_id`),
  ADD KEY `participantgroup_id` (`participantgroup_id`);

--
-- Indexes for table `competition_participantsgroup_score`
--
ALTER TABLE `competition_participantsgroup_score`
  ADD PRIMARY KEY (`participantgroup_score_id`),
  ADD KEY `competition_participantsgroup_score_ibfk_1` (`participantgroup_id`),
  ADD KEY `competition_participantsgroup_score_ibfk_2` (`criterion_id`),
  ADD KEY `competition_participantsgroup_score_ibfk_3` (`competition_id`);

--
-- Indexes for table `competition_participants_overall_score`
--
ALTER TABLE `competition_participants_overall_score`
  ADD PRIMARY KEY (`participant_overall_score_id`),
  ADD KEY `competition_participants_overall_score_ibfk_1` (`competition_id`),
  ADD KEY `competition_participants_overall_score_ibfk_2` (`participant_id`);

--
-- Indexes for table `competition_participants_score`
--
ALTER TABLE `competition_participants_score`
  ADD PRIMARY KEY (`participant_score_id`),
  ADD KEY `participant_id` (`participant_id`),
  ADD KEY `criterion_id` (`criterion_id`),
  ADD KEY `competition_participants_score_ibfk_4` (`competition_id`);

--
-- Indexes for table `competition_participant_type`
--
ALTER TABLE `competition_participant_type`
...
--
-- AUTO_INCREMENT for table `competitions_table`
--
ALTER TABLE `competitions_table`
  MODIFY `competition_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `competition_participantsgroup_overall_score`
--
ALTER TABLE `competition_participantsgroup_overall_score`
  MODIFY `competition_participantgroup_overall_score_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `competition_participantsgroup_score`
--
ALTER TABLE `competition_participantsgroup_score`
  MODIFY `participantgroup_score_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `competition_participants_overall_score`
--
ALTER TABLE `competition_participants_overall_score`
  MODIFY `participant_overall_score_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `competition_participants_score`
--
ALTER TABLE `competition_participants_score`
  MODIFY `participant_score_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `competition_participant_type`
--
ALTER TABLE `competition_participant_type`
  MODIFY `participant_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `competitions_table`
--
ALTER TABLE `competitions_table`
  ADD CONSTRAINT `competitions_table_ibfk_1` FOREIGN KEY (`event_type`) REFERENCES `event_type` (`event_type_id`);

--
-- Constraints for table `competition_participantsgroup_overall_score`
--
ALTER TABLE `competition_participantsgroup_overall_score`
  ADD CONSTRAINT `competition_participantsgroup_overall_score_ibfk_1` FOREIGN KEY (`competition_id`) REFERENCES `competitions_table` (`competition_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participantsgroup_overall_score_ibfk_2` FOREIGN KEY (`participantgroup_id`) REFERENCES `pjparticipantsgroup` (`participants_id_group`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `competition_participantsgroup_score`
--
ALTER TABLE `competition_participantsgroup_score`
  ADD CONSTRAINT `competition_participantsgroup_score_ibfk_1` FOREIGN KEY (`participantgroup_id`) REFERENCES `pjparticipantsgroup` (`participants_id_group`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participantsgroup_score_ibfk_2` FOREIGN KEY (`criterion_id`) REFERENCES `criterion` (`criterion_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participantsgroup_score_ibfk_3` FOREIGN KEY (`competition_id`) REFERENCES `competitions_table` (`competition_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `competition_participants_overall_score`
--
ALTER TABLE `competition_participants_overall_score`
  ADD CONSTRAINT `competition_participants_overall_score_ibfk_1` FOREIGN KEY (`competition_id`) REFERENCES `competitions_table` (`competition_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participants_overall_score_ibfk_2` FOREIGN KEY (`participant_id`) REFERENCES `pjparticipants` (`participants_id_individual`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `competition_participants_score`
--
ALTER TABLE `competition_participants_score`
  ADD CONSTRAINT `competition_participants_score_ibfk_1` FOREIGN KEY (`participant_id`) REFERENCES `pjparticipants` (`participants_id_individual`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participants_score_ibfk_3` FOREIGN KEY (`criterion_id`) REFERENCES `criterion` (`criterion_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `competition_participants_score_ibfk_4` FOREIGN KEY (`competition_id`) REFERENCES `competitions_table` (`competition_id`) ON DELETE CASCADE ON UPDATE CASCADE;
