...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2023 at 01:37 AM
...
(1, 1, '6360830-Muhammad-Ali-Quote-Don-t-count-the-days-make-the-days-count.jpg', 0, 'Bwn ng wk', 'Bwn ng wk');
...
(3, '2023-06-27', '05:50:44', 1, 'Added in Events'),
(4, '2023-06-27', '05:52:34', 1, 'Added in Events'),
(5, '2023-06-27', '06:11:09', 1, 'Edited in Event History');
...
(1, 1, 'asdasdasdasdasdasd', 'sfeQ3aPhd13T', '2023-06-28', '10:57:00', 1, 1);
...
--
ALTER TABLE `category_name`
  MODIFY `category_name_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `criterion`
  MODIFY `criterion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `ongoing_criterion`
  MODIFY `ongoing_criterion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
